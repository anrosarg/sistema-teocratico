<nav x-data="{ open: false }" class="bg-gray-100 shadow-sm border-b border-gray-200">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16 items-center">
            <!-- Logo / Título -->
            <div class="flex-shrink-0 flex items-center font-bold text-gray-800">
                Sistema Teocrático
            </div>

            <!-- Navegación principal (oculta en móviles) -->
            <div class="hidden sm:flex sm:items-center sm:space-x-6 text-sm font-medium text-gray-700">
    ...
    <div x-show="open" @click.outside="open = false" class="sm:hidden mt-2 px-4 pb-4 space-y-2 text-sm text-gray-700 bg-white shadow-md border-t border-gray-200">
